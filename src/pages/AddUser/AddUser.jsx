  ...
  return (
    ...
    >
      <div className="font-semibold pt-1">
        <h1 className="uppercase font-semibold font-mono text-2xl">Add A New user</h1>
      </div>
      ...
      <div className="font-semibold pt-2">
        <textarea
          name="bio"
          id="bio"
          className="placeholder:capitalize text-sm rounded-md px-3 py-3 shadow-md w-96 h-64 resize-none"
          placeholder="Bio ..."
